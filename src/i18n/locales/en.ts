export default {
  ...
  farmerSubscriptionStatus: "Subscription Status",
  ...
  manageSubscriptionPlan: "Manage your subscription plan, track usage, and handle billing",
  ...
  normalTier: "Normal",
  premiumTier: "Premium",
  starterFarm: "Starter Farm",
  professionalFarm: "Professional Farm",
  enterpriseFarm: "Enterprise Farm",
  
  // Plan Features
  features: "Features",
  includedFeatures: "Included Features",
  birdsMonitoring: "birds monitoring",
  upTo: "Up to",
  basicHealthTracking: "Basic health tracking",
  advancedHealthTracking: "Advanced health tracking",
  comprehensiveHealthTracking: "Comprehensive health tracking",
  dailyProductionReports: "Daily production reports",
  weeklyReports: "Weekly reports",
  realTimeReports: "Real-time reports",
  subscriptionEmailNotifications: "Email notifications",
  subscriptionSmsNotifications: "SMS notifications",
  subscriptionPushNotifications: "Push notifications",
  ...
  responseTime24h: "24h response",
  responseTime12h: "12h response",
  responseTime2h: "2h response",
  ...
  subscriptionViewDetails: "View Details",
  
  // Alerts & Notifications
  subscriptionExpiringSoon: "Your subscription expires soon",
  subscriptionExpiredAlert: "Your subscription has expired",
  paymentFailed: "Payment failed",
  paymentSuccessful: "Payment successful",
  planChanged: "Plan changed successfully",
  subscriptionCancelledAlert: "Subscription cancelled",
  ...
  faqSubscription: "Subscription FAQ",
  billingQuestions: "Billing Questions",
  technicalSupport: "Technical Support",
  capacity: "capacity",
  
  // Additional subscription interface keys
  chooseFarmPlan: "Choose Your Farm Plan",
  selectPerfectPlan: "Select the perfect plan for your farm size and requirements. All plans include mobile app access and basic support.",
  mostPopular: "MOST POPULAR",
  upToBirds: "Up to {{birds}} birds",
  subscriptionCurrentPlanLabel: "Current Plan",
  ...
  // Alerts & notifications
  automaticPaymentsEnabled: "Automatic Payments Enabled",
  subscriptionAutoRenewMsg: "Your subscription will automatically renew on {{date}}.",
  ...
  supportContactMessage: "Contact our support team for assistance with billing, upgrades, or technical issues. We're here to help your farm succeed!",
  
  // Usage statistics
  monthlyReports: "Monthly Reports",
  dataStorage: "Data Storage",
  generatedThisMonth: "Generated this month",
  farmDataAnalytics: "Farm data & analytics",
  activeMonitoringDevices: "Active monitoring devices",
  subscriptionSensorsActive: "Sensors Active",
  
  // Quick actions
  subscriptionQuickActions: "Quick Actions",
  subscriptionViewAnalytics: "View Analytics",
  openDashboard: "Open Dashboard",
  subscriptionExportData: "Export Data",
  subscriptionGenerateReport: "Generate Report",
  ...
  // Charts
  farmActivityTrends: "Farm Activity Trends",
  resourceDistribution: "Resource Distribution",
  
  // Modal
  upgradeToPlan: "Upgrade to {{planName}} Plan",
  planUpgrade: "Plan Upgrade",
  upgradingToPlan: "You're upgrading to the {{planName}} plan for ${{price}}/{{cycle}}. Your new features will be available immediately.",
  whatYouWillGet: "What you'll get:",
  subscriptionCancel: "Cancel",
  subscriptionConfirmUpgrade: "Confirm Upgrade",
  ...
  sidebarQuickOverview: "Quick Overview",
  sidebarActiveBatches: "Active Batches",
  sidebarTotalBirds: "Total Birds",
