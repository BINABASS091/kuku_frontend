        ...
        <form onSubmit={handleSubmit}>
          <VStack spacing={4} align="stretch">
            ...
            <FormControl isRequired>
              ...
              <Input name="batchActivityName" value={form.batchActivityName} onChange={handleChange} />
            </FormControl>
            <FormControl isRequired>
            ...
            <FormControl>
              ...
              <Textarea name="batchActivityDetails" value={form.batchActivityDetails} onChange={handleChange} />
            </FormControl>
            <FormControl>
