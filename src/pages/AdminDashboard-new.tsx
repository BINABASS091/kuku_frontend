...
import { StatsCards, QuickActions, SystemAlertsBanner, DashboardTabs, DataManagement } from '../features/admin/dashboard/components';

// Enhanced Admin Dashboard with integrated data management using modals
